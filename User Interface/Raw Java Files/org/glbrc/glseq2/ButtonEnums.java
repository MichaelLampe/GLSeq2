...
public final class ButtonEnums {
	public enum AttributeButton {
		UPDATE("Updating from Database"), NO_UPDATE(
				"NOT Updating from Database"),
		//
		PREPROCESSING("Pre-Processing Data"), NO_PREPROCESSING(
				"NOT Pre-Processing Data"),
		//
		...
		//
		BACKGROUND("Running in the Background"), NO_BACKGROUND(
	...
	public enum Attribute {
		/*
		 * These are all based on whatever the arguments taht are requested by
		 * the Rscript are
		 */
