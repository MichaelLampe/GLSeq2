...
#
counts.fName <- paste(collectDir, text.add, ".RSEM.counts.csv", sep="")
counts_pme.fName <-  paste(collectDir, text.add, ".RSEM.counts_pme.csv", sep="")
FPKM.fName <-  paste(collectDir, text.add, ".RSEM.FPKM.csv", sep="")
FPKM_pme.fName <-  paste(collectDir, text.add, ".RSEM.FPKM_pme.csv", sep="")
FPKM_lower.fName <-  paste(collectDir, text.add, ".RSEM.FPKM_lower.csv", sep="")
FPKM_upper.fName <-  paste(collectDir, text.add, ".RSEM.FPKM_upper.csv", sep="")
TPM.fName <-  paste(collectDir, text.add, ".RSEM.TPM.csv", sep="")
TPM_pme.fName <-  paste(collectDir, text.add, ".RSEM.TPM_pme.csv", sep="")
TPM_lower.fName <-  paste(collectDir, text.add, ".RSEM.TPM_lower.csv", sep="")
TPM_upper.fName <-  paste(collectDir, text.add, ".RSEM.TPM_upper.csv", sep="")
#
